...
begin;
  ...
  -- force_parish_id rewrites a forged parish_id back to her own
  insert into public.collections (parish_id, client_id, date, mass_time, total)
    values ('a2222222-2222-2222-2222-222222222222', 'PROBE-1', current_date, '6:00 AM', 100);
